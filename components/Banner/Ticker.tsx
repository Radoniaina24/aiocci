...
export default function Ticker({
  ...
  direction = "left",
  pauseOnHover = true,
  backgroundColor = "bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600",
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 bottom-0 w-8 sm:w-16 bg-gradient-to-r from-blue-600 to-transparent z-10 pointer-events-none" />
      <div className="absolute right-0 top-0 bottom-0 w-8 sm:w-16 bg-gradient-to-l from-purple-600 to-transparent z-10 pointer-events-none" />
