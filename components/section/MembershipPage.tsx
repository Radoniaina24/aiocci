...
import { HeroSection } from "./membership/HeroSection";
import { MembershipSection } from "./membership/MembershipSection";
import { ImportantNoteSection } from "./membership/ImportantNoteSection";
import Partners from "./Partners";
import InstitutionalPartners from "./InstitutionalPartners";
import { PartnersSection } from "./membership/PartnersSection";

// ==================== TYPES ====================

// ==================== ICONS ====================
export const Icons = {
  Crown: ({ className = "w-8 h-8" }: { className?: string }) => (
  ...
  Rocket: ({ className = "w-8 h-8" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Institution: ({ className = "w-8 h-8" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Award: ({ className = "w-8 h-8" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Media: ({ className = "w-8 h-8" }: { className?: string }) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
...
// Sample partner data - Replace with actual logos and links

// Partners Section Component

// ==================== MAIN COMPONENT ====================
const MembershipOne: React.FC = () => {
  return (
